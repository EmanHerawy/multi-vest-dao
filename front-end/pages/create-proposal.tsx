        ...
        <main className="w-full flex flex-col py-4 flex-grow max-w-5xl items-center">
          <div className="w-3/4 border-2 border-blue-600 rounded-xl p-3 mt-10">
            <div className="flex flex-col justify-center">
              ...
              <p className="mt-4">
                You will need to lock 5 EGLD to create proposal.
              </p>
              <p className="text-sm mb-4">
                If proposal is accepted, you will be refunded 5 EGLD and if
                proposal is rejected, 5 EGLD will go to DAO treasury.
              </p>
