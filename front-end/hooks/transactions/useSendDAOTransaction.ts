...
export const useSendDAOTransaction = (type: SessionEnum) => {
  ...
  const sendPingTransaction = async (amount?: string) => {
    ...
    const { sessionId } = await sendTransactions({
      transactions: proposeTransaction,
      transactionsDisplayInfo: {
        processingMessage: 'Processing proposing transaction',
        errorMessage: 'An error has occured during proposing',
        successMessage: 'proposing transaction successful'
      },
